...
print commands.getstatusoutput('sudo mkdir  /tmp/'+d_name)
print commands.getstatusoutput('sudo mount  /dev/myvg/'+d_name+'  /tmp/'+d_name)
print commands.getstatusoutput(' sudo echo "/tmp/'+d_name +' *(rw,no_root_squash)" >/etc/exports')
...
f.write("commands.getstatusoutput('mount 192.168.2.19:/tmp/"+d_name+" /media/"+d_name+"')\n")
f.close()
...
print   "<META HTTP-EQUIV=refresh CONTENT='0 ; URL=http://192.168.2.19/client.tar\n'>"
